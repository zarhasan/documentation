...
$plugins = [
    [
        ...
        'description' => 'Fast and lightweight Search engine',
...
<h2><?php esc_html_e('Essential Plugins') ?></h2>

<ul role="list" class="divide-y divide-gray-100 bg-white p-8 mb-8 flex flex-col gap-4">
